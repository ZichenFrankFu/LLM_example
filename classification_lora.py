...
def train(mymodel, num_epochs, train_dataloader, validation_dataloader, test_dataloder, device, lr, small_subset=False):
    ...
    for epoch in range(num_epochs):
        ...
        for i, batch in tqdm(enumerate(train_dataloader)):
            ...
            predictions = output.logits #don't need to argmax according to documentation.
    ...
    plt.legend()
    save_path = f"lora_overfit_{mymodel.name_or_path}_{lr}_{num_epochs}.png" if small_subset else f"base_lora_{mymodel.name_or_path}_{lr}_{num_epochs}.png"
